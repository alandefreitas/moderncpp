...
* [Basic](snippets/basic/)
    * [Hello World](snippets/basic/hello_world.cpp)
...
* [Utilities](snippets/utilities/)
    ...
    * [Async_pools](snippets/utilities/async_pools.cpp)
    * [Format](snippets/utilities/format.cpp)
    * [Network](snippets/utilities/network.cpp)
    * [Network_async](snippets/utilities/network_async.cpp)
* [GUI](snippets/gui/)
