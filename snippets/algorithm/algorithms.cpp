    ...
    std::cout << "Non-modifying sequence operations:" << std::endl;
    {
        ...
        if (i1 == v.end()) {
            ...
            std::cout << "The first adjacent pair of equal elements at: "
                      << std::distance(v.begin(), i1) << std::endl;
        }
        ...
        if (result2 == v.end()) {
            ...
            std::cout << "Last subsequence is at: "
                      << std::distance(v.begin(), result2) << std::endl;
        }
    }
    ...
    std::cout << "Binary search:" << std::endl;
    {
        ...
        if (range.first != v.end()) {
            std::cout << "15 from positions " << range.first - v.begin()
                      << " to " << range.second - v.begin() << std::endl;
        }
    }
