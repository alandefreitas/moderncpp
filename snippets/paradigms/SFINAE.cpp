...
int main() {
    std::cout << "Modern C++:" << std::endl;
    {
        ...
        std::cout << "is_odd: " << std::is_function<decltype(is_odd<int>)>::value << std::endl;
        std::cout << "id_even: " << std::is_function<decltype(is_even<int>)>::value << std::endl;
        ...
        // SFINAE on functions
        std::cout << "i is odd: " << is_odd(1) << std::endl; // is_odd(1.2) wouldn't work
        std::cout << "i is even: " << is_even(1) << std::endl; // is_even(1.2) wouldn't work
