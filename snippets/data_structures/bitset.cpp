...
int main() {
    ...
    cout << "sizeof(unsigned char) = " << sizeof(unsigned char) << " bytes" << endl;
    ...
    cout << "~(unit << 0) = " << bitset<32>(~(unit << 0)) << endl;
    cout << "r & (~(unit << 0)) = " << bitset<32>(r & (~(unit << 0))) << endl << endl;

    cout << "unit << 1 = " << bitset<32>(unit << 1) << endl;
    cout << "~(unit << 1) = " << bitset<32>(~(unit << 1)) << endl;
    cout << "r & (~(unit << 1)) = " << bitset<32>(r & (~(unit << 1))) << endl << endl;

    cout << "unit << 2 = " << bitset<32>(unit << 2) << endl;
    cout << "~(unit << 2) = " << bitset<32>(~(unit << 2)) << endl;
    cout << "r & (~(unit << 2)) = " << bitset<32>(r & (~(unit << 2))) << endl << endl;

    cout << "unit << 3 = " << bitset<32>(unit << 3) << endl;
    cout << "~(unit << 3) = " << bitset<32>(~(unit << 3)) << endl;
    cout << "r & (~(unit << 3)) = " << bitset<32>(r & (~(unit << 3))) << endl << endl;

    cout << "unit << 4 = " << bitset<32>(unit << 4) << endl;
    cout << "~(unit << 4) = " << bitset<32>(~(unit << 4)) << endl;
    cout << "r & (~(unit << 4)) = " << bitset<32>(r & (~(unit << 4))) << endl << endl;

    cout << "unit << 5 = " << bitset<32>(unit << 5) << endl;
    cout << "~(unit << 5) = " << bitset<32>(~(unit << 5)) << endl;
    cout << "r & (~(unit << 5)) = " << bitset<32>(r & (~(unit << 5))) << endl << endl;

    cout << "unit << 6 = " << bitset<32>(unit << 6) << endl;
    cout << "~(unit << 6) = " << bitset<32>(~(unit << 6)) << endl;
    cout << "r & (~(unit << 6)) = " << bitset<32>(r & (~(unit << 6))) << endl << endl;

    cout << "unit << 7 = " << bitset<32>(unit << 7) << endl;
    cout << "~(unit << 7) = " << bitset<32>(~(unit << 7)) << endl;
    cout << "r & (~(unit << 7)) = " << bitset<32>(r & (~(unit << 7))) << endl << endl;

    cout << "unit << 8 = " << bitset<32>(unit << 8) << endl;
    cout << "~(unit << 8) = " << bitset<32>(~(unit << 8)) << endl;
    cout << "r & (~(unit << 8)) = " << bitset<32>(r & (~(unit << 8))) << endl << endl;
